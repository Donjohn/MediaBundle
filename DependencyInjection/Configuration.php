                    ...
                    ->children()
                        ->arrayNode('file')->addDefaultsIfNotSet()
                            ->children()
                                ...
                                ->scalarNode('allowed_mimetype')->defaultValue([])->end()
                        ...
                        ->arrayNode('image')->addDefaultsIfNotSet()
                            ->children()
                                ...
                                ->scalarNode('allowed_mimetype')->defaultValue(['image/bmp', 'image/gif', 'image/jpeg', 'image/jpg', 'image/png', 'image/tiff', 'image/jpeg', 'image/png'])->end()
                                ->scalarNode('enabled')->defaultValue(true)->end()
                            ->end()
                        ->end()
                    ->end()
